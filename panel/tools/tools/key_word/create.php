...
<div class="card ">
    <div class="card-inner">
        <div class="card-head">
            <h5 class="card-title">تولید کلمه کلیدی بر اساس موضوع</h5>
        </div>
        <form action="#">
            <div class="row g-4">
                <div class="col-lg-6">
                    <div class="col-lg-12">
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            <h6>کلمات کلیدی برای چه هستند؟</h6>
                            <textarea name="" id="text" cols="30" class="form-control" placeholder="برای تولید کلمه کلیدی کمی درباره موضوع خود بنویسید" rows="10"></textarea>
                        </div>
                    </div>
                    <br>
                    <div class="col-12">
...
<script>
   ...
   $('#send').click(function() {
    ...
    $.ajax({
        url : '<?php echo url."WEB_C/".$_SESSION["WEB_C"]."/KEYWORD_CREATOR" ?>',
        type : 'POST',
        data : form,
