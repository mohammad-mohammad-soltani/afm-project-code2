...
<div class="nk-block">
    ...
    <div class="row g-gs filter-container" data-animation="true" style="position: relative; height: 1582.2px;" >
        ...
        <a href="<?php echo url."tag/create" ?>" class="col-sm-6 col-xxl-3 filter-item ai" data-category="ai" style="position: absolute; left: 461.4px; top: 384.825px;">
            <div class="card card-full">
                <div class="card-inner">
                    <div class="user-avatar text-primary bg-primary-dim mb-3">
        ...
        <a href="<?php echo url."keyword/create" ?>" class="col-sm-6 col-xxl-3 filter-item ai" data-category="ai" style="position: absolute; left: 461.4px; top: 384.825px;">
            <div class="card card-full">
                <div class="card-inner">
                    <div class="user-avatar text-primary bg-primary-dim mb-3">
                        <em class="icon ni ni-flag-fill"></em>
                    </div>
                    <h5 class="title">ساخت کلمه کلیدی</h5>
                    <p class="sub-text">ابزاری که کلمات کلیدی را برای رتبه اول سرچ گوگل به شما پیشنهاد میدهد</p>
                </div>
            </div><!-- .card -->
        </a><!-- .col -->
        <a href="<?php echo url."post/create_subject" ?>" class="col-sm-6 col-xxl-3 filter-item ai" data-category="ai" style="position: absolute; left: 461.4px; top: 384.825px;">
            <div class="card card-full">
                <div class="card-inner">
                    <div class="user-avatar text-primary bg-primary-dim mb-3">
                        <em class="icon ni ni-flag-fill"></em>
                    </div>
                    <h5 class="title">پیشنهاد موضوع مقاله</h5>
                    <p class="sub-text">در این ابزار شما با دادن دو جمله میتوانید به تعداد دلخواه پیشنهاد هایی از مقالات را مشاهده کنید</p>
                </div>
            </div><!-- .card -->
        </a><!-- .col -->
        <a href="<?php echo url."story/idea" ?>" class="col-sm-6 col-xxl-3 filter-item ai" data-category="ai" style="position: absolute; left: 0px; top: 587.962px;">
            <div class="card card-full">
                <div class="card-inner">
                    <div class="d-inline-flex position-absolute end-0 top-0 me-4 mt-4">
                        <div class="badge border-0 text-bg-light rounded-pill text-uppercase">جدید</div>
                    ...
                    <h5 class="title">ایده استوری</h5>
                    <p class="sub-text">ایده استوری برای پیج های شما</p>
                </div>
            </div><!-- .card -->
        </a><!-- .col -->
